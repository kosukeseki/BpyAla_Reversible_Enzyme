...
species = ['25', '27', '32', '35',
            ...
            '47', '48', '51', 'WT',
            'GFP', '-']
mutations = ['Blank','216/516','214/442','159/513','167/517','158/512','169/516','237/439','238/516','156/513','161/516','215/520','167/513','169/512','156/516','238/442','170/513','158/514','167/516','191/513','159/512','191/517','215/524','169/510','159/517','191/520','169/514','214/524','2TAG-sfGFP', 'WT']
...
window = 5
##middle of sliding window with five points = 3rd position
mid = 2
...
fig, ax = plt.subplots(nrows = 3,
                       ...
                       sharex = True, 
                       sharey = True)
colors = ['gray', 'darkgreen', 'lightgreen']
...
for enz in species:
    for conc in conditions:
        ...
        ###find the max slope and its stdev over time period
        ...
        slope_dict[enz+str(conc)] = (maxslope,maxslopestd)

###plotting
count1 = 0
count2 = 0
count3 = 0
xticklabels = ['-Ni', '+Ni', '+Ni, +EDTA']
for enz in species:
    for conc in conditions:
        ax[count1,count2].bar(str(conc),slope_dict[enz+str(conc)][0], yerr = slope_dict[enz+str(conc)][1],color = colors[conditions.index(conc)])
...
for ax in fig.axes:
    plt.sca(ax)
    plt.xticks([0,1,2], xticklabels, rotation=45)

###adjustments on plots
fig.text(0.05, 0.5, 'Rate (AU/min) at 30°C', va = 'center', rotation = 'vertical')
fig.subplots_adjust(left = 0.1, bottom = 0.17, wspace=0.5, hspace = 0.5)
##fig.savefig('210614_rates_bar_edta_Ni_seed2021.pdf')
